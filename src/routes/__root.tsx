...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AcadHire is a specialist recruitment consultancy helping schools, EdTech companies, and education organizations identify, assess and hire academic, leadership, and operations talent." },
      { name: "author", content: "AcadHire" },
      { property: "og:title", content: "AcadHire | Specialist Recruitment for the Education Sector" },
      { property: "og:description", content: "AcadHire is a specialist recruitment consultancy helping schools, EdTech companies, and education organizations identify, assess and hire academic, leadership, and operations talent." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "AcadHire" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "AcadHire | Specialist Recruitment for the Education Sector" },
      { name: "twitter:description", content: "AcadHire is a specialist recruitment consultancy helping schools, EdTech companies, and education organizations identify, assess and hire academic, leadership, and operations talent." },
    ],
    links: [
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: "AcadHire is a specialist recruitment consultancy helping schools, EdTech companies, and education organizations identify, assess and hire academic, leadership, and operations talent.",
